...
class TestUIIntegration(unittest.TestCase):
    ...
    def test_game_loop_initialization(self, mock_set_mode: MagicMock) -> None:
        ...
        with patch("pygame.init"), \
             ...
             patch("src.interfaces.pygame_adapter.rendering.grid_display.GridDisplay"):
            ...
            mock_surface.subsurface.assert_called_with(game_loop.layout_manager.simulation_area)
    ...
    def test_resize_handling(self, mock_set_mode: MagicMock) -> None:
        ...
        with patch("pygame.init"), \
            ...
            with patch("pygame.event.get", return_value=[mock_event]):
                ...
                game_loop.layout_manager.handle_resize.assert_called_once_with((1024, 768))
    ...
    def test_render_sequence(self, mock_set_mode: MagicMock) -> None:
        ...
        with patch("pygame.init"), \
             patch("pygame.time.Clock"), \
             patch("src.interfaces.pygame_adapter.rendering.grid_display.GridDisplay") as mock_grid_display, \
            ...
            self.assertEqual(
                game_loop.command_column.render.call_count, 1,
                "Command column should be rendered once"
            )
            
            # Check that separator is rendered
            self.assertEqual(
                game_loop.layout_manager.render_separator.call_count, 1,
                "Separator should be rendered once"
            )
            
            # Check that grid is rendered
            self.assertEqual(
                game_loop.grid_display.render.call_count, 1,
