...
def test_game_loop_render(mock_pygame: MagicMock) -> None:
    ...
    with patch("src.main.GridDisplay") as mock_grid_display, patch(
        "src.main.LayoutManager"
    ) as mock_layout_manager, patch("src.main.CommandColumn") as mock_command_column:
